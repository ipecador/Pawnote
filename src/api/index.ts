...
export * from "./discussion-send-new-discussion-draft";
...
export * from "./evaluation-categories";
...
export * from "./news-surveys";
export * from "./news";
export * from "./notebook";
export * from "./partner-url";
export * from "./periods";
export * from "./public-parents";
export * from "./public-staff";
export * from "./public-students";
export * from "./public-teachers";
